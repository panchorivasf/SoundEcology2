...
#' \itemize{
#'   \item \code{trill_spectral}: A matrix of trill index values across frequencies and time.
#'   \item \code{trill_summary}: A tibble summarizing trill index statistics, including values for low and mid-frequency noise.
#' }
#'
#' @export
#'
...
tai <- function(wave,
  ...
  invisible(list(trill_spectral = trill_spectral, trill_summary = trill_summary))
}
